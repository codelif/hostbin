...
func TestClassifyHost(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "public host", host: "doc1.domain.com", wantKind: HostKindPublic, wantSlug: "doc1"},
		{name: "public host with port", host: "doc1.domain.com:443", wantKind: HostKindPublic, wantSlug: "doc1"},
		{name: "admin host", host: "admin.domain.com", wantKind: HostKindAdmin},
